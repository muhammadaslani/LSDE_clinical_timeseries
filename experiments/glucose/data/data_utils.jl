function load_dataset(; n_samples=512, batchsize=16, split=(0.5, 0.3), obs_fraction=0.5,
    ...
    if n_samples <= 512
        ...
        data, train_loader, val_loader, test_loader, dims, ts_obs, ts_for, normalization_stats =
            load_dataset_in_chunks(; n_samples=n_samples, batchsize=batchsize, split=split,
...
function load_dataset_in_chunks(; n_samples=512, batchsize=64, split=(0.5, 0.3),
    ...
    for i in 1:n_chunks
        ...
        data, train_loader, val_loader, test_loader, dims, ts_obs, ts_for, normalization_stats =
            load_dataset(n_samples=current_samples, batchsize=batchsize, split=split,
