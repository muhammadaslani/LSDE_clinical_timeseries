function load_dataset(; n_samples=512, batchsize=32, split=(0.5, 0.3), obs_fraction=0.5,
...
function load_dataset_in_chunks(; n_samples=512, batchsize=32, split=(0.5, 0.3),
