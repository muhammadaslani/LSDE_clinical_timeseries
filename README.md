...
4. **Generation**: Generate new samples from the model $(\hat{x}_{1:T}, \hat{y}_{1:T}) \sim \hat{p}(x_{1:T}, y_{1:T} \mid u_{1:T}) \approx p_{\text{data}}(x_{1:T}, y_{1:T} \mid u_{1:T})$.
