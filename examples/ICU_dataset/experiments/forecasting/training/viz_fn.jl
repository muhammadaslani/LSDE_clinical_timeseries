...
function viz_fn(t_obs, t_for, obs_data, future_true_data, forecasted_data; sample_n=1, plot=true, confidence_level=0.9)
    u_obs, x_obs, y_obs, masks_obs = obs_data
    u_for, x_for, y_for, masks_for = future_true_data
    μ, σ² = forecasted_data
    σ = σ²  # Convert variance to standard deviation
