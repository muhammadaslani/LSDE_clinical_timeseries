...
function output_head(hidden_dim::Int, output_dim::Vector{Int}, n_layers::Int=2)
    ...
    final_layer = MultiDecoder(fill(hidden_dim, num_heads), output_dim; hidden_size=hidden_dim, depth=n_layers, dist="Gaussian")
...
# hidden_dim = 64
# sequence_length = 10
# output_dim = [6,1,1] # Output dimensions for each output head
# control_dim = 2
# batch_size = 8
# n_layers=8
